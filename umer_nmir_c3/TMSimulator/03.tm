...
* <- CallExp
20: ST 0,-6(5)	load user input
21: LD 0,-5(5)	load address of lhs into ac
22: LD 1,-6(5)	load rhs constant into ac1
23: ST 1,0(0)	storing rhs constant into address of lhs
24: ST 1,-2(5)	storing rhs constant into offet of assignExp
* -> SimpleVar
* looking up id: fac
...
28: ST 0,-6(5)	load const(1) <- constant
29: LD 0,-5(5)	load address of lhs into ac
30: LD 1,-6(5)	load rhs constant into ac1
...
34: ST 0,-5(5)	 <- constant
* <- SimpleVar
35: LDC 0,1(0)	load const(1) <- constant
36: ST 0,-6(5)	load const(1) <- constant
37: LD 0,-5(5)	load lhs value into ac
38: LD 1,-6(5)	load rhs value into ac1
...
* -> SimpleVar
* looking up id: fac
45: LDA 0,-3(5)	load id address
* <- id
46: ST 0,-5(5)	op: push left
* <- SimpleVar
* -> SimpleVar
47: LD 0,-3(5)	load value of var into AC
48: ST 0,-7(5)	 <- constant
* <- SimpleVar
* -> SimpleVar
49: LD 0,-2(5)	load value of var into AC
50: ST 0,-8(5)	 <- constant
* <- SimpleVar
51: LD 0,-7(5)	load lhs value into ac
52: LD 1,-8(5)	load rhs value into ac1
53: MUL 0,0,1	mul values of ac and ac1 into ac
54: ST 0,-6(5)	storing rhs constant into address of lhs
55: LD 0,-5(5)	load address of lhs into ac
56: LD 1,-6(5)	load rhs constant into ac1
...
* <- id
60: ST 0,-5(5)	op: push left
* <- SimpleVar
* -> SimpleVar
61: LD 0,-2(5)	load value of var into AC
62: ST 0,-7(5)	 <- constant
* <- SimpleVar
63: LDC 0,1(0)	load const(1) <- constant
64: ST 0,-8(5)	load const(1) <- constant
65: LD 0,-7(5)	load lhs value into ac
66: LD 1,-8(5)	load rhs value into ac1
67: SUB 0,0,1	sub values of ac and ac1 into ac
68: ST 0,-6(5)	storing rhs constant into address of lhs
69: LD 0,-5(5)	load address of lhs into ac
70: LD 1,-6(5)	load rhs constant into ac1
71: ST 1,0(0)	storing rhs constant into address of lhs
72: ST 1,-2(5)	storing rhs constant into offet of assignExp
73: LDA 7,-41(7)	while: absolute jmp to test
44: JEQ 0,29(7)	while: jmp to end
* <- while
* -> CallExp
* -> SimpleVar
74: LD 0,-3(5)	load value of var into AC
75: ST 0,-4(5)	 <- constant
* <- SimpleVar
76: ST 0,-6(5)	Storing value of arg 1 into (-4)fp
...
83: LD 7,-1(5)	return back to the caller
11: LDA 7,72(7)	jump forward to finale
84: ST 5,0(5)	push ofp
85: LDA 5,0(5)	push frame
86: LDA 0,1(7)	load ac with ret ptr
87: LDA 7,-76(7)	jump to main loc
